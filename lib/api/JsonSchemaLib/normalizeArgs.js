...
var ono = require('ono');
var validateConfig = require('../Config/validateConfig');
 ...
 * @returns {{ error: ?Error, url: ?string, data: *, config: object, callback: ?function }}
 */
function normalizeArgs (args) {
  ...
  try {
    ...
    // Throw an error if the config is invalid. Or default to an empty object if no config was given
